...
from db2i_tools.prompt import QUERY_CHECKER
...
class BaseDb2iDatabaseTool(BaseModel):
    ...
    db: Db2iDatabase = Field(None, description="The database connection object")
...
class QuerySQLDatabaseTool(BaseDb2iDatabaseTool, BaseTool):  # type: ignore[override, override]
...
class InfoSQLDatabaseTool(BaseDb2iDatabaseTool, BaseTool):  # type: ignore[override, override]
...
class ListSQLDatabaseTool(BaseDb2iDatabaseTool, BaseTool):  # type: ignore[override, override]
