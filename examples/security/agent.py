...
agent = Agent(
    model=OpenAIChat(),
    tools=[count_exposed_profiles, list_exposed_profiles, fix_exposed_profiles, run_corrective_query, get_security_metrics],
    ...
    To retrieve security data, you can use these tools:
    ...
    - Provide the exact SQL commands to fix issues
    
    Provide clear explanations of the security issues and actionable recommendations 
